...
const DynamicProductPage = () => {
  ...
  // Format the slug for display title (e.g. "men-clothes" -> "Men Clothes")
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        // Ideally we would filter by category/slug here: `${api}/api/v1/product?category=${slug}`
        // But per user request/current implementation, we fetch all products for now.
  ...
  return (
    <section className="py-8 md:py-12 lg:py-16 2xl:py-20">
      <div className="container mx-auto space-y-6 2xl:space-y-10 px-4 sm:px-6 lg:px-0 py-8">
        {/* Header */}
