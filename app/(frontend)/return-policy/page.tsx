import { policySections as staticPolicySections } from "@/types/constants/returnPolicy";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 max-w-4xl mx-auto border border-orange-200">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              At Smart Wear, we strive to provide a seamless shopping experience
              by featuring a curated collection of stylish, high-quality
              T-shirts available through Amazon.
            </p>
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <p className="text-red-800 font-medium text-center">
                ⚠️ Please note: We do not sell, ship, or process returns
                directly — all transactions are completed and managed by Amazon
                or the respective Amazon sellers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-orange-500">
            ...
            <p className="text-gray-600 text-sm">
              Browse our curated T-shirt collection
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-blue-500">
            ...
            <p className="text-gray-600 text-sm">
              Click through to complete your order
            </p>
          </div>
          <div className="bg-white rounded-xl p-6 shadow-lg border-l-4 border-green-500">
            ...
            <p className="text-gray-600 text-sm">
              All returns processed by Amazon
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          <div className="bg-gradient-to-br from-orange-500 to-red-500 text-white rounded-2xl p-8">
            ...
            <p className="mb-4 opacity-90">
              For all order-related issues, returns, refunds, or delivery
              questions:
            </p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mt-8 text-center border border-orange-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">
            Thank You for Choosing Smart Wear!
          </h3>
          <p className="text-gray-600 leading-relaxed">
            We&apos;re committed to helping you discover amazing T-shirts while
            providing clear guidance on the return process through our trusted
            partner, Amazon.
          </p>
        </div>
      </div>
