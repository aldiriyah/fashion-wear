import { shippingInfo } from "@/types/constants/shippingData";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="text-lg text-gray-600 leading-relaxed mb-8">
              At Smart Wear, we aim to make your shopping experience smooth, transparent, and hassle-free. 
              We showcase a curated selection of stylish and comfortable T-shirts available through Amazon, 
              one of the world&apos;s most trusted online marketplaces.
            </p>
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-6 flex flex-col sm:flex-row items-start gap-4 shadow-lg">
              ...
              <div className="text-amber-800">
                <strong className="font-semibold">Important Note:</strong> Smart Wear does not handle product sales, shipping, or delivery 
                directly. All purchases, shipping, and logistics are managed by Amazon or the individual 
                sellers operating on Amazon.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-center">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl p-8 shadow-2xl max-w-2xl w-full">
            <h3 className="text-2xl font-bold text-center mb-6">Quick Summary</h3>
