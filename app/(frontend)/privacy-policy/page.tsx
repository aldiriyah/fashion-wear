import { policySections } from "@/types/constants/privacy";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 mt-2 leading-relaxed">
              At Smart Wear, your privacy is extremely important to us. We are committed to protecting your 
              personal information and being transparent about how we handle it.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-gray-100">
          <p className="text-gray-700 leading-relaxed text-lg">
            ...
            visit our website, interact with our content, or use any of our services. By visiting or 
            using Smart Wear, you agree to the practices described in this policy. If you do not agree, 
